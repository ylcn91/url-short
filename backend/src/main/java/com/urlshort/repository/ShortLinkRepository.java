...
public interface ShortLinkRepository extends JpaRepository<ShortLink, Long> {
     ...
     *
     * Note: maxClicks is stored in the metadata JSONB field, so this query is commented out.
     * To implement this functionality, you would need to:
     * 1. Add a native SQL query that queries JSONB metadata
     * 2. Or use a scheduled job that loads links and checks metadata programmatically
     *
